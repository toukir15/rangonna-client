...
export default function QuartzChronograph() {
  ...
  const mergedCategories = Array.from(
    new Set([...(categories || []), "quartz-chronograph"])
  );
      ...
      <div className="flex gap-4">
        <div className="xl:block hidden md:w-1/5">
          <FilterSideBar
            ...
            filterCategories="quartz-chronograph"
        ...
        <div className="xl:w-4/5 w-full">
          <div className="flex items-center justify-between">
            <div className="text-lg flex flex-wrap items-center gap-1">
              <Link href="/">Home</Link> /{" "}
              <Link href="/watches/quartz-chronograph">Chronograph</Link>
