...
export default function MultiFunctionQuartz() {
  ...
  const mergedCategories = Array.from(
    new Set([...(categories || []), "multi-function-quartz"])
  );
      ...
      <div className="flex gap-4">
        <div className="xl:block hidden md:w-1/5">
          <FilterSideBar
            ...
            filterCategories="multi-function-quartz"
        ...
        <div className="xl:w-4/5 w-full">
          <div className="flex items-center justify-between">
            <div className="text-lg flex flex-wrap items-center gap-1">
              <Link href="/">Home</Link> /{" "}
              <Link href="/watches/multi-function-quartz">Multi Function</Link>
