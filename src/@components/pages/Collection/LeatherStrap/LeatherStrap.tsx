...
export default function LeatherStrap() {
  ...
  const mergedCategories = Array.from(
    new Set([...(categories || []), "leather-strap"])
  );
      ...
      <div className="flex gap-4">
        <div className="xl:block hidden md:w-1/5">
          <FilterSideBar
            ...
            filterCategories="leather-strap"
        ...
        <div className="xl:w-4/5 w-full">
          <div className="flex items-center justify-between">
            <div className="text-lg flex flex-wrap items-center gap-1">
              <Link href="/">Home</Link> /{" "}
              <Link href="/watches/leather-strap">Leather</Link>
            ...
            <div className="flex items-center gap-2 text-gray-500">
              {hasAnyFilterActive && (
                <button
                  onClick={clearAll}
                  className="ml-auto text-xs px-2 py-0.5 bg-primary-light text-primary rounded-full border border-primary-border hover:bg-primary-lighter cursor-pointer"
