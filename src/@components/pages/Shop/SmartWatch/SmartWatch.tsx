...
export default function SmartWatch() {
  ...
  const mergedCategories = Array.from(
    new Set([...(categories || []), "smart-watches"])
  );
      ...
      <div className="flex gap-4">
        <div className="xl:block hidden md:w-1/5">
          <FilterSideBar
            ...
            filterCategories={"smart-watches"}
        ...
        <div className="xl:w-4/5 w-full">
          <div className="flex items-center justify-between">
            <div className="sm:text-lg xs:text-base flex flex-wrap items-center gap-1">
              <Link href="/">Home</Link> / <Link href="/watches">Watches</Link>/{" "}
              <Link href="/watches/smart-watches">Smart</Link>
