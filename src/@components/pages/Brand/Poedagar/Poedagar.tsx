...
export default function PoedagarBrand() {
  ...
  const mergedCategories = Array.from(new Set([...(brands || []), "poedagar"]));
  ...
  const queryParams = useMemo(() => {
    const params: Record<string, any> = {
      ...
      ...(mergedCategories.length ? { brand: mergedCategories.join(",") } : {}),
        ...
        <div className="xl:w-4/5 w-full">
          <div className="flex items-center justify-between">
            <div className="text-lg flex flex-wrap items-center gap-1">
              <Link href="/">Home</Link> /{" "}
              <Link href="/brand/poedagar">Poedagar</Link>
