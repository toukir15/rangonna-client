    ...
    <>
      <div className="fixed inset-0 overflow-y-auto z-50">
        ...
        <div className="flex items-start justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          <div
            className={`inline-block align-bottom bg-white  rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-top ${width} ${maxWidth} ${className} animate-slide-down`}
            role="dialog"
            aria-modal="true"
...
Modal.Header = ({
  ...
  <div className={`px-6 pt-6 pb-4 border-b border-gray-300  ${className}`}>
    {children}
  </div>
);
