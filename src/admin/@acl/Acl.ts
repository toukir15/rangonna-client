export const labelPermissionMap: Record<string, string[]> = {
  ...
  "paymentreport/summary": ["account_view"],
  "paymentreport/methodsummary": ["account_view"],
  ...
  "product/wholesale": ["product_view"],
  ...
  "productstock/mywarehouse": ["stock_transfer_receive"],
  ...
  "team/member": ["team_permission_view"],
  "team/permission": ["team_permission_view"],
  "team/report": ["team_user_report_view"],
  "team/holidaypayment": ["team_permission_view"],
  "team/advancesalary": ["team_permission_view"],
  "team/salary": ["team_permission_view"],
  "team/salaryreport": ["team_permission_view"],
  ...
  "dutyplan/duty": ["roster_plan_view"],
  ...
  "setting/expense": ["expense_settings_view", "account_settings_view"],
