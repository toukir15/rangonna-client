                ...
                <div className="w-full min-h-72 py-2">
                    {holidayInfo?.holidays?.length > 0 ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {holidayInfo?.holidays?.map((user: any, index: number) => (
                                <div
                                    key={user?._id || index}
                        ...
                        <div className="min-h-60 flex flex-col items-center justify-center text-center">
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                This duty does not have any assigned holidays.
                            </p>
                        </div>
                    )}
                </div>
...
export default HolidayQuickViewModal;