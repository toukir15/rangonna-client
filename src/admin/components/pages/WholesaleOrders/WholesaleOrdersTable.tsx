...
import { WholeSaleOrdersContext } from "@/app/admin/orders/wholesale-orders/page";
import ButtonLoader from "@admin/components/core/Button/ButtonLoader";
import { useReactToPrint } from "react-to-print";
import { wholesaleOrderService } from "@admin/@services/apis/OrdersService/wholesaleOrder.service";
import InvoiceNew from "../AllOrders/InvoiceNew";
import PackingSlipPrint from "../AllOrders/PackingSlipPrint";
import { dueColor } from "@admin/utils/constant";

const WholesaleOrdersTable: React.FC = () => {
  ...
  const {
    ...
    // handleCreatePayment,
    // handleShowPayments,
  } = useContext(WholeSaleOrdersContext);
  ...
  const fetchAndPrint = async (
    ...
    try {
      ...
      const res: any = await wholesaleOrderService.getInvoicePrint(orderId);
          ...
          {orderList?.map((order: any, index: number) => {
            ...
            return (
              ...
              >
                ...
                <Td>
                  <Link
                    href={`/orders/wholesale-orders/view/${order?._id}`}
