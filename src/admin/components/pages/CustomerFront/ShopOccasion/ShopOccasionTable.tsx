...
import { ShopOccasionContext } from "@/app/admin/customer-front/shop-occasion/page";
...
const ShopOccasionTable = () => {
    const router = useRouter();
    const { collectionData, tableLoading, handleRemove } =
        useContext(ShopOccasionContext);
                                        ...
                                        {popupIndex === index && (
                                            ...
                                            >
                                                <button
                                                    ...
                                                    onClick={() => {
                                                        router.push(
                                                            `/admin/customer-front/shop-occasion/edit/${item?._id}`
                                                        );
                                                    }}
                                                >
                                                    Edit
...
export default ShopOccasionTable;
