...
import { BikretaOrderListContext } from "@/app/admin/orders/bikreta/page";
...
const BikretaTable: React.FC = () => {
  ...
  const {
    ...
    handleImageClick,
    filter,
  } = useContext(BikretaOrderListContext);
