...
import { TimeVerseOrderListContext } from "@/app/admin/orders/timeverse/page";
...
const TimeVerseTable: React.FC = () => {
  ...
  const {
    ...
    // setModalOpen,
    filter,
  } = useContext(TimeVerseOrderListContext);
