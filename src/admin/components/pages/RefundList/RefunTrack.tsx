...
const RefunTrack: React.FC<ShippingTrackerProps> = ({
    currentStep,
    updateOrderStatus,
    statusLoading,
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg md:px-0 md:py-2 px-2 py-4">
            ...
            {isLocked && (
                <div className="mt-2 text-center">
                    <div className={`flex-col items-center rounded-lg p-4 ${currentStep === "rejected" ? "bg-red-50 border border-red-200" : "bg-green-50 border border-green-200"}`}>
                        <Icon name="verified" className={`text-3xl mb-2 ${currentStep === "rejected" ? "text-red-600" : "text-green-600"}`} />
                        <p className={`font-semibold text-base ${currentStep === "rejected" ? "text-red-700" : "text-green-700"}`}>
                            {currentStep}
                        </p>
                        <p className={`text-sm ${currentStep === "rejected" ? "text-red-600" : "text-green-600"}`}>
