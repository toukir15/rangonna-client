...
import Select from "@admin/components/core/Select/Select"; // 👈 your select component
...
const DEFAULT_STATUSES: StatusItem[] = [
  ...
  { name: "Received", status: "received-product" },
  { name: "Assign", status: "assign" },
  { name: "Sent Supplier", status: "product-sent-to-supplier" },
  { name: "Received Supplier", status: "received-from-supplier" },
  { name: "Checking", status: "checking" },
  { name: "Solved", status: "solved" },
  { name: "Delivery", status: "delivery" },
  { name: "R-D", status: "ready-for-box" },
