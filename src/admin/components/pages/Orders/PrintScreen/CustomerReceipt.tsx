...
const getPhone = (entry: MaybeOrder) =>
  entry?.customer?.phone || entry?.customer_phone || entry?.order_phone || "";
...
const CustomerReceipt = ({
  ...
  // Effective content width for thermal printers:
  // 58mm paper printable ~48mm; 80mm ~72mm. We keep safe content width.
