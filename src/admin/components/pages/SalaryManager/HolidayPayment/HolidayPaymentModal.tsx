...
const HolidayPaymentModal: React.FC = () => {
  const { isModalOpen, setIsModalOpen, modalMode, getAdvanceList } = useContext(
    HolidayPaymentContext,
  );
  ...
  const formSubmit = async (formData: any) => {
    ...
    const payload = {
      ...
      payment_source: ExpenseSource.HOLIDAY_SALARY_PAYMENT,
    };

    HolidaySalaryService.createHolidaySalary(payload)
      .then((res: any) => {
        if (res?.success) {
...
export default HolidayPaymentModal;
