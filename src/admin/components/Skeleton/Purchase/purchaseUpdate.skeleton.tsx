...
const PurchaseUpdateSkeleton: React.FC = () => {
  return (
    <div className="w-full  dark:bg-gray-700 rounded-lg grid grid-cols-3  gap-5 mb-5">
...
export default PurchaseUpdateSkeleton;
