...
import {
  IProfitByOrderSummary,
  IProfitByOrderSummaryResponse,
  ...
  return (
    <AuthLayout>
      <div className="2xl:px-4 px-3 2xl:pt-4 md:pt-3 pt-2 pb-4 relative w-full">
        <PageHeader title="Monthly Profit" />
        
        <div className="data-table-card glass-card rounded-2xl orders-table-shell">
          <div className="premium-table-toolbar">
            <p className="premium-table-toolbar-title">Monthly Profit records</p>
            ...
            {dailyProfitData?.map(
              (profitData: IProfitByOrderSummary, index: number) => {
                return (
                  <Tr key={index}
                  >
                    <Td><span className="data-table-primary">{formatMonthYear(profitData?.date)}</span></Td>
                    <Td>
