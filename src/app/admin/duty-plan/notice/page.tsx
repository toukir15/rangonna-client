...
import NoticeTable from "@admin/components/pages/DutyPlan/Notice/NoticeTable";
const NoticeModal = dynamic(
    () => import("@admin/components/pages/DutyPlan/Notice/NoticeModal"),
    { ssr: false }
);
...
export const NoticeContext = createContext({} as any);
...
const Page: React.FC = () => {
    ...
    const confirmRemove = async () => {
        ...
        if (!remove) return;
        try {
            const res = await NoticeService.deleteNotice(remove);
            if (res?.success) {
                ...
                <div className="2xl:px-4 px-3 2xl:pt-4 md:pt-3 pt-2 md:pb-0 mb-2">
                    <div className="md:flex items-center gap-3">
                        <div className="flex items-center gap-3">
                            ...
                            {hasPermission(permissionList, "notice_create") && (
                                <Button
