...
const CompanyPolicyModal = dynamic(
    () => import("@admin/components/pages/DutyPlan/CompanyPolicy/CompanyPolicyModal"),
    { ssr: false }
);
import dynamic from "next/dynamic";
import CompanyPolicyTable from "@admin/components/pages/DutyPlan/CompanyPolicy/CompanyPolicyTable";
import { CompanyPolicyService } from "@admin/@services/apis/DutyPlan/CompanyPolicy/CompanyPolicy.service";
import PageSearch from "@admin/components/core/Search/PageSearch";

export const CompanyPolicyContext = createContext({} as any);
...
const Page: React.FC = () => {
    ...
    const fetchCompanyPolicy = () => {
        setTableLoading(true);
        CompanyPolicyService.getCompanyPolicy({
    ...
    const confirmRemove = async () => {
        ...
        if (!remove) return;
        try {
            const res = await CompanyPolicyService.deleteCompanyPolicy(remove);
            if (res?.success) {
                ...
                <div className="2xl:px-4 px-3 2xl:pt-4 md:pt-3 pt-2 md:pb-0 mb-2">
                    <div className="md:flex items-center gap-3">
                        <div className="flex items-center gap-3">
                            ...
                            {hasPermission(permissionList, "company_policy_create") && (
                                <Button
