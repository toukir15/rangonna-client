...
import HolidayNoticeTable from "@admin/components/pages/DutyPlan/HolidayNotice/HolidayNoticeTable";
import dynamic from "next/dynamic";
const HolidayNoticeModal = dynamic(
    () => import("@admin/components/pages/DutyPlan/HolidayNotice/HolidayNoticeModal"),
    { ssr: false }
);
import { HolidayNoticeService } from "@admin/@services/apis/DutyPlan/HolidayNotice/HolidayNotice.service";
import PageSearch from "@admin/components/core/Search/PageSearch";

export const HolidayNoticeContext = createContext({} as any);
...
const Page: React.FC = () => {
    ...
    const [holidayNoticeData, setHolidayNoticeData] = useState<any[]>([]);
    ...
    const getDeposit = () => {
        ...
        HolidayNoticeService.getHolidayNotice({
            ...
            .then((res: any) => {
                if (res?.success) {
                    setHolidayNoticeData(res?.data.data);
    ...
    const confirmRemove = async () => {
        ...
        if (!remove) return;
        try {
            const res = await HolidayNoticeService.deleteHolidayNotice(remove);
            if (res?.success) {
                ...
                <div className="2xl:px-4 px-3 2xl:pt-4 md:pt-3 pt-2 md:pb-0 mb-2">
                    <div className="md:flex items-center gap-3">
                        <div className="flex items-center gap-3">
                            ...
                            {hasPermission(permissionList, "team_holiday_notice_create") && (
                                <Button
