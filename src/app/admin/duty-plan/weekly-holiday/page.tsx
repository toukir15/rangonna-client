...
import WeeklyHolidayTable from "@admin/components/pages/DutyPlan/WeeklyHoliday/WeeklyHolidayTable";
import WeeklyHolidayModal from "@admin/components/pages/DutyPlan/WeeklyHoliday/WeeklyHolidayModal";
import { WeeklyHolidayService } from "@admin/@services/apis/DutyPlan/WeeklyHoliday/WeeklyHoliday.service";
import PageSearch from "@admin/components/core/Search/PageSearch";

export const WeeklyHolidayContext = createContext({} as any);
...
const Page: React.FC = () => {
    ...
    const [weeklyHolidayData, setWeeklyHolidayData] = useState<any[]>([]);
    ...
    const getDeposit = () => {
        ...
        WeeklyHolidayService.getWeeklyHoliday({
            ...
            .then((res: any) => {
                if (res?.success) {
                    setWeeklyHolidayData(res?.data.data);
    ...
    const confirmRemove = async () => {
        ...
        if (!remove) return;
        try {
            const res = await WeeklyHolidayService.deleteWeeklyHoliday(remove);
            if (res?.success) {
                ...
                <div className="2xl:px-4 px-3 2xl:pt-4 md:pt-3 pt-2 md:pb-0 mb-2">
                    <div className="md:flex items-center gap-3">
                        <div className="flex items-center gap-3">
                            ...
                            {hasPermission(permissionList, "weekly_holiday_create") && (
                                <Button
