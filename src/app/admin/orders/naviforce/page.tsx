...
import NaviforceTable from "@admin/components/pages/AllOrders/Naviforce/NaviforceTable";
...
export const NaviforceOrderListContext = createContext({} as any);
...
const Page: React.FC = () => {
  ...
  const fetchOrdersList = async () => {
    ...
    OrdersService.getNaviforceOrders({
  ...
  return (
    <AuthLayout className={` ${selectedOrder.value === "all" ? "" : ""}`}>
      ...
      <NaviforceOrderListContext.Provider
        value={{
          orderList,
          tableLoading,
          selectedOrders,
