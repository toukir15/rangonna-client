...
import BikretaTable from "@admin/components/pages/AllOrders/Bikreta/BikretaTable";
...
export const BikretaOrderListContext = createContext({} as any);
...
const Page: React.FC = () => {
  ...
  const fetchOrdersList = async () => {
    ...
    OrdersService.getBikretaOrders({
  ...
  return (
    <AuthLayout className={` ${selectedOrder.value === "all" ? "" : ""}`}>
            ...
            <div className="md:flex items-center md:space-x-4">
              ...
              <div className="md:flex items-center gap-5 ">
                {/* <CalendarRange
                  range={range}
                  setRange={setRange}
                  className="lg:!w-72 md:!w-56 w-full"
                /> */}
      ...
      <BikretaOrderListContext.Provider
        value={{
          orderList,
          tableLoading,
          selectedOrders,
