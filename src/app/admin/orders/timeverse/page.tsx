...
import TimeVerseTable from "@admin/components/pages/AllOrders/TimeVerse/TimeVerseTable";
...
export const TimeVerseOrderListContext = createContext({} as any);
...
const Page: React.FC = () => {
  ...
  const fetchOrdersList = async () => {
    ...
    OrdersService.getTimeVerseOrders({
  ...
  return (
    <AuthLayout className={` ${selectedOrder.value === "all" ? "" : ""}`}>
      ...
      <TimeVerseOrderListContext.Provider
        value={{
          orderList,
          tableLoading,
          selectedOrders,
