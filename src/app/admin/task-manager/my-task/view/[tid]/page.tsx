...
import MyNotesUpdateModal from "@admin/components/pages/TaskManager/MyTask/TaskDetails/MyNotesUpdateModal";
import MyTaskDetailsStatus from "@admin/components/pages/TaskManager/MyTask/TaskDetails/MyTaskDetailsStatus";
            ...
            <div className="md:flex items-center md:space-x-4 w-full">
              ...
              <div className="">
                <h1 className="2xl:text-2xl lg:text-xl text-lg font-semibold dark:text-gray-300 text-gray-800 md:mb-0 mb-2 flex text-nowrap">
                  My Task Details : {taskDetails?.task_no}
                </h1>
              </div>
            </div>
          </div>
  ...
  `}
        ...
        `}
              ...
              <div>
                ...
                <div className="mt-1 space-y-1 md:text-start text-center mx-auto w-full flex flex-col md:items-start items-center">
        ...
        <div className="mt-4 md:flex gap-4 items-start">
          <div className="md:w-8/12 w-full h-auto">
            ...
            <div className="bg-white p-6 rounded-lg mt-4">
              <h2 className="py-4 font-bold">Documents:</h2>
