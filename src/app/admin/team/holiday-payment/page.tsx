...
import HolidayPaymentTable from "@admin/components/pages/SalaryManager/HolidayPayment/HolidayPaymentTable";
import HolidayPaymentModal from "@admin/components/pages/SalaryManager/HolidayPayment/HolidayPaymentModal";
import { HolidaySalaryService } from "@admin/@services/apis/SalaryManager/HolidayPayment/HolidayPayment.service";

export const HolidayPaymentContext = createContext<any>({} as any);
...
const Page = (): JSX.Element => {
  ...
  const getAdvanceList = () => {
    ...
    HolidaySalaryService.getHolidaySalary({
      page: currentPage,
    ...
    <AuthLayout>
      ...
      <NoScrollLayout>
        <div className="flex items-center justify-between 2xl:px-4 px-3 2xl:pt-4 md:pt-3 pt-2 md:pb-0 mb-2">
          ...
          <div>
            {permissionList.includes("team_holiday_salary_create") && (
              <Button
                className="flex items-center bg-blue-500 !px-4"
                onClick={handleAddClick}
              >
                <Icon name={"add"} />
                <span className="ml-1">Add Holiday Payment</span>
              </Button>
            )}
          </div>
        </div>
      ...
      <div className="min-h-[75vh] 2xl:px-4 px-3">
        <div className="xl:mt-3 mt-2">
          <HolidayPaymentContext.Provider
            value={{
              advanceData,
              tableLoading,
              handleRemove,
