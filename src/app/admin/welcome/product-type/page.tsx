...
const Page: React.FC = () => {
  ...
  const formSubmit = async (productData: FormValues) => {
    setIsSubmit(true);

    AuthService.master_user({ product_type: productData.agreement })
      .then((res: any) => {
        if (res?.success) {
          ToastService.success(res?.message);
          router.push("/admin/welcome/store-design");
        } else {
  ...
  const options = [
    {
      ...
      extraOption: "Clothing, Shoe, Accessories",
    },
    {
      value: "electronics & gadgets",
      label: "Electronics & Gadgets",
      extraOption: "Computer, Mobile Phone, Gadget, Home Appliances",
    },
    {
      value: "health & beauty",
      label: "Health & Beauty",
      extraOption: "Cosmetics, Medicine, Food Supplments, Baby Food",
    },
    {
      value: "home & furniture",
      label: "Home & Furniture",
      extraOption: "Furniture, Home Decor, Gift Items",
    },
    {
      value: "others",
      label: "Others",
      extraOption: "Miscellaneouse Products",
    },
  ];
