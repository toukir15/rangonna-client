  ...
  return (
    <AuthLayout>
      <div className="2xl:px-4 px-3 2xl:pt-4 md:pt-3 pt-2 pb-4 relative w-full">
        <PageHeader title="Facebook Adset Report" />
        
        <div className="data-table-card glass-card rounded-2xl orders-table-shell">
          <div className="premium-table-toolbar">
            <p className="premium-table-toolbar-title">Facebook Adset records</p>
          ...
          <Tbody>
            {tableData?.map((data: IFacebookUtmTermReport, index: number) => {
              ...
              return (
                <Tr key={index}
                >
                  <Td><span className="data-table-primary">{data?.utm_term_id}</span></Td>
