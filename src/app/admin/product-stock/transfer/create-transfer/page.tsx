...
const webSchema = yup.object({
  receiver_warehouse: yup.mixed().required("Warehouse is required"),
...
const Page: React.FC = () => {
  ...
  const formSubmit = (data: any) => {
    ...
    StockTransferService.createStockTransfer(payload)
      .then((res: any) => {
        if (res?.success) {
          ToastService.success(res?.message);
          router.push(`/product-stock/transfer/view/${res?.data?._id}`);
        } else {
      ...
      >
        ...
        <div className="flex gap-3 items-end justify-end mt-auto pt-4">
          <Button
            ...
            onClick={() => {
              router.push("/admin/product-stock/my-warehouse");
            }}
          >
            Cancel
          </Button>
