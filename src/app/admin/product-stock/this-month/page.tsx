  ...
  return (
    <AuthLayout>
      <div className="2xl:px-4 px-3 2xl:pt-4 md:pt-3 pt-2 pb-4 relative w-full">
        <PageHeader title="This Month Stock Report" />
        
        <div className="data-table-card glass-card rounded-2xl orders-table-shell">
          <div className="premium-table-toolbar">
            <p className="premium-table-toolbar-title">This Month Stock records</p>
            ...
            {thisMonthData?.map((report: any, index: number) => {
              return (
                ...
                >
                  ...
                  <Td><span className="data-table-muted">{report?.saved_remaining_stock}</span></Td>
